package org.htech.interactiveperiodictable.graphs;
...
public class ElectronegativityVsAtomicMassChart extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.getIcons().add(new Image(String.valueOf(Objects.requireNonNull(getClass().getResource("/icons/electro.png")))));
        stage.show();
    }
